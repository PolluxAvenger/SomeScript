...
def ipv6_data(person_info, result_list):
    header = {
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/46.0.2486.0 Safari/537.36 Edge/13.10586'
    }

    url = 'http://ipwhois.cnnic.net.cn/bns/query/Query/ipwhoisQuery.do?txtquery=' + person_info + '&queryOption=ipv6'
    ...
    with open('cnnic_ipv6.data', 'wb') as f:
...
if __name__ == "__main__":
    data_list = []
    data_list = ipv6_data('2001:F88::', data_list)
